...
class FileManager
{
     ...
     * otherwise.
     *
     * @param string $dir The directory where to store files.
     ...
     * @param string $value A string to store.
     * @param string $ext The storing file extension.
     * @param boolean $writeable Whether this value can be written on disk.
     * @param boolean $override Whether to override an already existing file.
     * @return string The hash of $key, or null in case of error.
     ...
     * will be overriden.
     * @param string $value A string to store using itself as key.
     * @param string $ext The storing file extension.
     * @param boolean $writeable Whether this value can be written on disk.
     * @param boolean $override Whether to override an already existing file.
     * @return string The hash of $value, or null in case of error.
     * @throws Exception If this FileManager directory is not accessible.
     */
     ...
     * @param string $key A string key.
     * @return boolean true if $key already exists, false otherwise.
     * @throws Exception If this FileManager directory is not accessible.
     */
     ...
     * @param string $h A string key hash in hexadecimal.
     * @return boolean true if $h already exists, false otherwise.
     * @throws Exception If this FileManager directory is not accessible.
     */
     ...
     * @param string $key A string key.
     * @return string A string value, or null if $key does not exist.
     * @throws Exception If this FileManager directory is not accessible.
     */
     ...
     * @param string $h A string key hash in hexadecimal.
     * @return string A string value, or null if $h does not exist.
     * @throws Exception If this FileManager directory is not accessible.
     */
     ...
     * $key.
     * @param string $key A string key.
     * @return string A filename, or null if the value does not exist or is not stored
     *         in a file.
     * @throws Exception If this FileManager directory is not accessible.
     */
     ...
     * @param string $key A string key.
     * @return boolean true if the element existed and could be removed.
     * @throws Exception If this FileManager directory is not accessible.
     */
     ...
     * @param string $f A filename.
     * @return string The filename prepended by this FileManager directory.
     */
     ...
     * @param string $key A string key.
     * @return array An array, or null if the key $key does not exist.
     * @throws Exception If this FileManager directory is not accessible.
     ...
     * @param string $h A string key hash in hexadecimal.
     * @return array An array, or null if the hash $h does not exist.
     * @throws Exception If this FileManager directory is not accessible.
     */
     ...
     * @param string $value A string value that will be stored to a file.
     * @return string The transformed value (by default, same as $value).
     */
     ...
     * @param string $value A string value that will be stored in memory.
     * @return string The transformed value (by default, same as $value).
     */
     ...
     * @param string $h The value key hash.
     * @param string $ext The value extension.
     * @return string The value filename.
     */
     ...
     * @return string A hash as an hexadecimal string.
     */
     ...
     * @param boolean $override Whether to override an already existing file.
     * @return boolean true if the element was correctly added or already exists, and
     *         false otherwise.
     * @throws Exception If this FileManager directory is not accessible.
     */
     ...
     * @param string $filename An element filename.
     * @param string $content A string to write.
